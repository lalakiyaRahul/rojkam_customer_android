...
//                recreate();
            ...
            case R.id.page_4:
                ...
                break;
            case R.id.page_5:
                if(HomeFragment.getInstance().categoryAdapter.getmCatlist()!=null &&
                        !HomeFragment.getInstance().categoryAdapter.getmCatlist().isEmpty()){
                    Intent i = new Intent(this, HearActivity.class);
                    Bundle b = new Bundle();
                    b.putParcelableArrayList("cat_list", HomeFragment.getInstance().categoryAdapter.getmCatlist());
                    i.putExtras(b);
                    startActivity(i);
