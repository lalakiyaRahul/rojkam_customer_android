package com.cscodetech.townclap.locationpick;
...
import com.cscodetech.townclap.activity.HomeActivity;
...
public class LocationGetActivity extends BasicActivity implements OnMapReadyCallback, GetResult.MyListener {
